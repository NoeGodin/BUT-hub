...
export class TetrisComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  constructor(
    private tetrominoesService: TetrominoesService,
  ...
  gameInit() {
    ...
    this.currentTetromino = this.tetrominoesService.randomTetromino(
      this.BOARD_WIDTH
    );
    this.nextTetromino = this.tetrominoesService.randomTetromino(
      this.BOARD_WIDTH
    );
    this.clearGameBoard();
